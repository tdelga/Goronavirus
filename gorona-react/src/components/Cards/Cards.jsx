  ...
  return (
    <div className={styles.container}>
      <Grid container spacing={3} justify="center">
        <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.confirmados)}>
          <CardContent>
        ...
        <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.muertos)}>
          <CardContent>
